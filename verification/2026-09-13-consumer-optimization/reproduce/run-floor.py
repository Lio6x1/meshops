...
results=[]
for trial,variant in enumerate(('batch','batch'),7):
    args=scale.parse_args(['--entities','10000','--rates','1500','--seconds','30','--deadline-seconds','720','--warmup-seconds','300','--sample-seconds','5','--image','meshops-consumer-opt:'+variant])
    ...
    (here/'floor-trials.json').write_text(json.dumps(results,indent=2)+'\n',encoding='utf-8')
