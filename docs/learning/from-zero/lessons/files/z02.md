...
| 路径 | 操作 | 完整原文件 |
| --- | --- | --- |
| `.gitignore` | 保留 | [完整文件](../../starter/z02/.gitignore) |
| `cmd/entity/main.go` | 创建 | [完整文件](../../starter/z02/cmd/entity/main.go) |
| `cmd/query/main.go` | 创建 | [完整文件](../../starter/z02/cmd/query/main.go) |
| `configs/entity.yaml` | 创建 | [完整文件](../../starter/z02/configs/entity.yaml) |
| `gen/common/v1/entity.pb.go` | 保留 | [完整文件](../../starter/z02/gen/common/v1/entity.pb.go) |
| `gen/entity/v1/entity_grpc.pb.go` | 保留 | [完整文件](../../starter/z02/gen/entity/v1/entity_grpc.pb.go) |
| `gen/entity/v1/entity.pb.go` | 保留 | [完整文件](../../starter/z02/gen/entity/v1/entity.pb.go) |
| `generate.ps1` | 保留 | [完整文件](../../starter/z02/generate.ps1) |
| `go.mod` | 替换 | [完整文件](../../starter/z02/go.mod) |
| `go.sum` | 替换 | [完整文件](../../starter/z02/go.sum) |
| `internal/config/config.go` | 创建 | [完整文件](../../starter/z02/internal/config/config.go) |
| `internal/service/entity_test.go` | 创建 | [完整文件](../../starter/z02/internal/service/entity_test.go) |
| `internal/service/entity.go` | 创建 | [完整文件](../../starter/z02/internal/service/entity.go) |
| `proto/common/v1/entity.proto` | 保留 | [完整文件](../../starter/z02/proto/common/v1/entity.proto) |
| `proto/entity/v1/entity.proto` | 保留 | [完整文件](../../starter/z02/proto/entity/v1/entity.proto) |
| `smoke.ps1` | 创建 | [完整文件](../../starter/z02/smoke.ps1) |
