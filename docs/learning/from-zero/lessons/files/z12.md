...
| `cmd/account-admin/main.go` | 保留 | [完整文件](../../web-stages/z12/cmd/account-admin/main.go) |
| `cmd/account-admin/main_test.go` | 保留 | [完整文件](../../web-stages/z12/cmd/account-admin/main_test.go) |
...
| `internal/accounts/http_integration_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/http_integration_test.go) |
| `internal/accounts/integration_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/integration_test.go) |
| `internal/accounts/password.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/password.go) |
| `internal/accounts/password_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/password_test.go) |
| `internal/accounts/store.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/store.go) |
| `internal/accounts/store_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/accounts/store_test.go) |
...
| `internal/platform/account_auth_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/platform/account_auth_test.go) |
...
| `internal/platform/network.go` | 保留 | [完整文件](../../web-stages/z12/internal/platform/network.go) |
| `internal/platform/network_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/platform/network_test.go) |
...
| `internal/platform/registry_decode.go` | 保留 | [完整文件](../../web-stages/z12/internal/platform/registry_decode.go) |
| `internal/platform/registry_decode_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/platform/registry_decode_test.go) |
...
| `internal/web/accounts.go` | 保留 | [完整文件](../../web-stages/z12/internal/web/accounts.go) |
| `internal/web/accounts_test.go` | 保留 | [完整文件](../../web-stages/z12/internal/web/accounts_test.go) |
...
| `migrations/005_accounts.sql` | 保留 | [完整文件](../../web-stages/z12/migrations/005_accounts.sql) |
...
| `scripts/account-admin.ps1` | 保留 | [完整文件](../../web-stages/z12/scripts/account-admin.ps1) |
| `scripts/account-admin.test.ps1` | 保留 | [完整文件](../../web-stages/z12/scripts/account-admin.test.ps1) |
...
| `web/src/accounts.ts` | 创建 | [完整文件](../../web-stages/z12/web/src/accounts.ts) |
...
| `web/src/views/Accounts.vue` | 创建 | [完整文件](../../web-stages/z12/web/src/views/Accounts.vue) |
...
| `web/src/views/PasswordChange.vue` | 创建 | [完整文件](../../web-stages/z12/web/src/views/PasswordChange.vue) |
...
| `web/tests/account-domain.test.ts` | 创建 | [完整文件](../../web-stages/z12/web/tests/account-domain.test.ts) |
| `web/tests/accounts.test.ts` | 创建 | [完整文件](../../web-stages/z12/web/tests/accounts.test.ts) |
...
<!-- file:web/src/views/Accounts.vue -->
`````vue
<script setup lang="ts">
...
### `web/src/views/PasswordChange.vue`

<!-- file:web/src/views/PasswordChange.vue -->
`````vue
<script setup lang="ts">
...
### `web/tests/account-domain.test.ts`

<!-- file:web/tests/account-domain.test.ts -->
`````typescript
...
### `web/tests/accounts.test.ts`

<!-- file:web/tests/accounts.test.ts -->
`````typescript
import test from 'node:test'
import assert from 'node:assert/strict'
